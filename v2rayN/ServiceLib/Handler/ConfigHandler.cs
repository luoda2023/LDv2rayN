...
public static class ConfigHandler
{
    ...
    public static Config? LoadConfig()
    {
        ...
        config.SimpleDNSItem.BlockAAAAQuery ??= true;
    ...
    public static async Task<int> AddSubItem(Config config, string url)
    {
        ...
        // Public subscription endpoints must use TLS. Plain HTTP remains available for local services only.
    ...
    public static SimpleDNSItem InitBuiltinSimpleDNS()
    {
        return new SimpleDNSItem()
        {
            ...
            // Prefer encrypted domestic DNS for direct-resolution latency while keeping remote
            // resolution on a separate resolver selected by the proxy core.
